...
class ImageCompare extends EAE_Widget_Base {
	...
	protected function render() {
        ...
        <figure <?php echo $this->get_render_attribute_string('wrapper'); ?> >
                <?php echo wp_get_attachment_image($settings['before_image']['id'], $settings['before_image_size_size'],'',$attr); ?>
            ...
            <div class="eae-img-comp-img eae-img-comp-overlay">
	            <?php echo wp_get_attachment_image($settings['after_image']['id'], $settings['after_image_size_size'],'',$attr); ?>
